...
local message = "Cellular AUTOMATA\n\n\nThis is an example of cellular automata and Maze generator. Press UP to generate new and wait ... ;)"
...
function Init()
  ...
  cave = TCellular:New()
  cave:Generate(128,128,0.6,3,5,5);

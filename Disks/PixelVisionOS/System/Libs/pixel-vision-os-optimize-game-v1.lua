function PixelVisionOS:OnOptimizeGame(srcPath, closeModalCallback)


    -- TODO Remove old cache
    -- TODO Create list of all sprites
    -- TODO Create new sprite cache image
    -- TODO Copy each sprite into cache image
    -- TODO Create new meta sprite
    -- TODO Save meta-sprite file and cache image
    -- TODO Create list of all tilemaps
    -- TODO Read each tilemap and copy new sprites into cache image
    -- TODO Create new tilemap.json file for each map
    ...
    if(self.progressModal == nil) then
        ...
        pixelVisionOS:RegisterUI({name = "UpdateOptimizeGame"}, "UpdateOptimizeGame", self, true)

    end

end

function PixelVisionOS:UpdateOptimizeGame()
    ...
    --         self.progressModal = nil
            ...
            pixelVisionOS:RemoveUI("UpdateOptimizeGame")

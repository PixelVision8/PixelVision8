...
function EditorUI:CreateButton(rect, spriteName, toolTip, spriteCache)

  spriteCache = spriteCache or true
...
function EditorUI:UpdateButtonSizeFromCache(data)
  ...
  if(spriteData ~= nil) then
    ...
    data.bgDrawArgs = {data.rect.x, data.rect.y, data.rect.width, data.rect.height, BackgroundColor(), DrawMode.TilemapCache}
...
--     end
--
--     -- TODO this needs to call Draw Rec
--     print("CAN'T CLEAR BUTTON")
--

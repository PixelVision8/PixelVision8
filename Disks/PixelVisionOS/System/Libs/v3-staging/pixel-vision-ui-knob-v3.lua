...
function EditorUI:CreateKnob(rect, spriteName, toolTip, colorOffset)
    ...
    data.colorOffsetDisabled = colorOffset
    print(data.colorOffsetDisabled, colorOffset, PaletteOffset( 7))
    data.colorOffsetUp = colorOffset + 4
    data.colorOffsetOver = colorOffset + 8

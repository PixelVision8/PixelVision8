...
function EditorUI:CreateNumberStepper(rect, inputWidth, value, min, max, spriteNamePrefix, toolTip, colorOffset)
    ...
    data.nextButton = self:CreatePaletteButton({x = data.inputField.rect.x + data.inputField.rect.w, y = rect.y}, spriteNamePrefix .. "steppernext", "Increase the value.", PaletteOffset(1))

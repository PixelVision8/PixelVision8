...
local buildTemplatePaths = {
    {name = "Windows", path = NewWorkspacePath("/PixelVisionOS/Runners/Runner Windows.pvr")},
    {name = "Mac", path = NewWorkspacePath("/PixelVisionOS/Runners/Runner Mac.pvr")},
    {name = "Linux", path = NewWorkspacePath("/PixelVisionOS/Runners/Runner Linux.pvr")}
}
...
function Init()
    ...
    if(success == true) then
        ...
        for i = 1, #tmpFiles do
            ...
            table.insert(filePaths, {name, selected})
        ...
        buildButtonData.onAction = function(value)
            ...
            for i = 1, #filePaths do
                ...
                if(filePaths[i][2] == true) then
                    ...
                    table.insert(libFilesToCopy, filePaths[i][1])
                end
            end
...
function OnSave()
    ...
    for i = 1, #filePaths do
        ...
        if(file[2] == true) then
            includeString = includeString .. file[1] .. ","
        end

...
--   if(success == true) then
    ...
    --     spriteData = self.gpuChips[i].spriteName .. "up"
    --   end
    ...
    --     spriteData = self.cartChips[i].spriteName .. "up"
    --   end
    ...
    --     spriteData = self.soundChips[i].spriteName .. "up"
    --   end
...
--       selectedLineDrawArgs[1] = FindMetaSpriteId("chipgpuselectedline")--.spriteIDs
--       selectedLineDrawArgs[2] = 128
--       selectedLineDrawArgs[3] = 112
--       -- selectedLineDrawArgs[4] = chipgpuselectedline.width

--       editorUI:ConfigureChipPicker(chipPicker, "self.gpuChips")
...
--       selectedLineDrawArgs[1] = FindMetaSpriteId("chipcartselectedline")--.spriteIDs
--       selectedLineDrawArgs[2] = 64
--       selectedLineDrawArgs[3] = 144
--       -- selectedLineDrawArgs[4] = chipcartselectedline.width

--       editorUI:ConfigureChipPicker(chipPicker, "self.cartChips")
...
--       selectedLineDrawArgs[1] = FindMetaSpriteId("chipsoundselectedline")--.spriteIDs
...
--       editorUI:ConfigureChipPicker(chipPicker, "self.soundChips")

...
//            var tmLeft = tilemapDrawRequest.x;
//            var tmTop = tilemapDrawRequest.y;
//            var tmRight = tilemapDrawRequest.x + tilemapDrawRequest.width;
//            var tmBottom = tilemapDrawRequest.y + tilemapDrawRequest.height;
//
...
//            var displayY = 0;
//            
//            var uiPixels = uiLayer.pixels;
//            
//            
//            var mapCachPixels = tilemapChip.cachedTileMap.pixels;
////
////            var row = 0;
////            var col = 0;
...
//            {
//                
//                // Check the UI layer first for a pixel
//                if (uiPixels[i] > -1)
//                {
//                    colorID = uiPixels[i];
//
...
//                    }
//                }
//                // Check the tilemap layer for a pixel
//                else
//                {
                    
//                    // Calculate map position
//                    mapX = displayX - tmLeft + scrollX;
//                    mapY = displayY + tmTop + (mapHeight - _height) - scrollY;
//    
...
//                    if (displayX >= tmLeft && displayX <= tmRight && displayY >= tmTop && displayY <= tmBottom)
//                    {
...
//    //
//    
//                        colorID = mapCachPixels[mapX + mapY * mapWidth];//tilemapChip.cachedTileMap.pixels[mapPixelIndex];
//    
...
//                    if (colorID == -1 && clearFlag == false)
//                    {
//                        colorID = displayPixels[i];
//                    }
////
//                }
////                
//                
//                //TODO need to see if clear was called, if not don't draw the new pixel
//
//                
//                
...
//                
//                // Reset color id value for next pixel
//                colorID = -1;
//                

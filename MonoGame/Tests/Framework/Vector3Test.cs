...
//             Assert.AreNotEqual(max.GetHashCode(),  new Vector3(0,0,0).GetHashCode());
//             Assert.AreNotEqual(min.GetHashCode(), new Vector3(0, 0, 0).GetHashCode());
//
//             // Common values
//             var a = new Vector3(0f, 0f, 0f);
//             Assert.AreEqual(a.GetHashCode(), new Vector3(0, 0, 0).GetHashCode());
//             Assert.AreNotEqual(a.GetHashCode(), new Vector3(0, 0, 0).GetHashCode());
//

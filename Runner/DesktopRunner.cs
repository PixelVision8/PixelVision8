...
namespace PixelVision8.Runner
{
    ...
    public class DesktopRunner : RunnerGame
    {
        ...
        protected override void ConfigureRunner()
        {
            ...
            Volume(Convert.ToInt32((long) workspaceService.ReadBiosData(BiosSettings.Volume.ToString(), 40L))
                .Clamp(0, 100));
...
//                    DisplayBootErrorScreen("Error parsing system bios.");
        ...
        public virtual void BootDone()
        {
            ...
            if (autoRunPath != null) workspaceService.MountDisk(autoRunPath, false);
        }

 ...
 namespace PixelVision8.Runner
{
    public class RunnerGame : Game, IRunner
    {
        ...
        public IEngine activeEngine { get; protected set; }
        ...
        protected bool stretchScreen = false;
...
//                Console.WriteLine("Local Storage " + localAppData);
        ...
        public int Scale(int? scale = null)
        {
            ...
            if (scale.HasValue)
            {
                _scale = MathUtil.Clamp(scale.Value, 1, 6);
...
//                ResetResolution();
        ...
        public virtual bool Fullscreen(bool? value = null)
        {
            ...
            return fullscreen;//Convert.ToBoolean(workspaceService.ReadBiosData(BiosSettings.FullScreen.ToString(), "False") as string);
        }
...
//                displayTarget?.MonitorResolution(scale: scale);
            ...
            return stretchScreen;//Convert.ToBoolean(workspaceService.ReadBiosData(BiosSettings.StretchScreen.ToString(), "False") as string);
        }
...
//                displayTarget?.MonitorResolution(scale: scale);
            ...
            return cropScreen;//Convert.ToBoolean(workspaceService.ReadBiosData(BiosSettings.CropScreen.ToString(), "False") as string);
        }
...
//		    // names of the chips it should use.
        ...
        {
            return new PixelVisionEngine(chips.ToArray());
        }

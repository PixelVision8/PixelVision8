...
namespace Microsoft.Xna.Framework.Graphics
{
    ...
    internal partial class EffectResource
    {
        ...
        public static readonly EffectResource SpriteEffect = new EffectResource(Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Content", "Effects", "SpriteEffect.ogl.mgfxo"));
            ...
            get
            {
                if (_bytecode == null)
                {
                    lock (_locker)
                    {
                        ...
                        _bytecode = File.ReadAllBytes(_name);

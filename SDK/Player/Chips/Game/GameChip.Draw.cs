...
namespace PixelVision8.Player
{
    public partial class GameChip
    {
        ...
        /// </param>
        public void DrawSprite(int id, int x, int y, bool flipH = false, bool flipV = false, DrawMode drawMode = DrawMode.Sprite, int colorOffset = 0)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    var pos = Utilities.CalculatePosition(id, SpriteChip.Columns);
                    pos.X *= SpriteWidth;
                    pos.Y *= SpriteHeight;

                    DisplayChip.NewDrawCall(SpriteChip, x, y, SpriteWidth, SpriteHeight, (byte) drawMode, flipH, flipV, colorOffset, pos.X, pos.Y);
